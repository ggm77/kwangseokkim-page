...
**다시 부르기 : 아날로그**는 한국 포크의 전설 김광석의 정규 1~4집, 다시부르기 1, 다시부르기 2 앨범을 LP 플레이어와 카세트 플레이어 형태로 체험할 수 있는 인터랙티브 웹 프로젝트입니다.
...
- **앨범 캐러셀** — 정규 1~4집 및 다시부르기 1, 다시부르기 2 앨범 커버를 3D 카드 형식으로 탐색
